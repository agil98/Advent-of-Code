...
def main():
    ...
    line1, dictionary1 = calculateLine(path1)
    line2, dictionary2 = calculateLine(path2)
    intersect = line1.intersection(line2)
    min = shortestPath = 1000000000 #Some default value
    
    for i in intersect:
        manhattanDist = abs(i[0]) + abs(i[1])
        if (manhattanDist < min):
            min = manhattanDist
            
        currPath = dictionary1[i] + dictionary2[i]
